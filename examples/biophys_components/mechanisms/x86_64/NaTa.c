...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 NaTa /allen/programs/celltypes/workgroups/humancolumn_ephysmodeling/yinaw/git_ateam/Human_all_active_models_EAP/examples/biophys_components/mechanisms/x86_64/NaTa.mod\n");
