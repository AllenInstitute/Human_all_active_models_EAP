...
net.add_nodes(N=1,  # specifiy the number of cells belong to said group.
              pop_name='POPNAME', location='LAYER', ei='e',  # pop_name, location, and ei are optional parameters that help's identifies properties of the cells. The modeler can choose whatever key-value pairs as they deem appropiate.
...
net.add_edges(source={'ei': 'e'}, target={'pop_name': 'POPNAME'},
              connection_rule=5,
              syn_weight=4e-05,
...
tw.add_edges(source=tw.nodes(), target=net.nodes(pop_name='POPNAME'),
             connection_rule=5,
             syn_weight=0.0000,
             weight_function='wmax',
             distance_range=[30.0, 150.0],
